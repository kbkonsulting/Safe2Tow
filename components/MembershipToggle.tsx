...
const MembershipToggle: React.FC<MembershipToggleProps> = ({ isPro, onToggle }) => {
  ...
  return (
    <div className="flex items-center gap-3 p-1 sm:p-2 bg-gray-100 dark:bg-gray-800/50 rounded-lg">
